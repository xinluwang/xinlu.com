...
Category data can be represented by fixed effect, all called **sparse tensors**. However this kind of representations will results in much higher dimmensions of input, and are less meaningful. It can memorize the training data without providing prediction powers for the out of sample data. When traning the neural network, This representation needs: 1) huge amount of data, and 2) huge amount of computation. 
...
<img src="/post/2019-01-01-embeddings-categorical-input-data_files/Jietu20190101-162553.png" alt="handdrawing classifications " width="95%"/>

### 3. movie recommendations 
![](/post/2019-01-01-embeddings-categorical-input-data_files/Jietu20190101-162648.png)

## the thumb up of choosing dimmensions
